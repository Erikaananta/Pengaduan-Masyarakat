            ...
            <div class="laporan-top">
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <?php if($v->status == '0'): ?>
                        <p class="text-danger">Belum Direspon</p>
                    ...
                    <div>
                        <p><?php echo e($v->tgl_pengaduan->format('d M, h:i')); ?></p>
                    </div>
                </div>
            </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© Erika A • 2021</p>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduan-masyarakat\resources\views/user/laporan.blade.php ENDPATH**/ ?>