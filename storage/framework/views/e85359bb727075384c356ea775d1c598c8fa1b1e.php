            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <?php if($pengaduan ?? ''): ?>
                            <a href="<?php echo e(route('laporan.cetakLaporan', ['from' => $from, 'to' => $to])); ?>" class="btn btn-danger">EXPORT PDF</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduan-masyarakat\resources\views/Admin/Laporan/index.blade.php ENDPATH**/ ?>